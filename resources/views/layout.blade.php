  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('admin_dashboard')}}">Dashboard</a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p>Profile name:</p>
              <p class="user-name">{{strtoupper($admin_info->admin_name)}}</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/result')}}">
                <i class="mdi mdi-puzzle menu-icon"></i>
                <span class="menu-title">Submit Result</span>
              </a>      
            </li>

            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/allresults')}}">
                <i class="mdi mdi-puzzle menu-icon"></i>
                <span class="menu-title">View All Results</span>
              </a>      
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/adminprofile')}}">View</a>
                  </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/swe')}}">SWE</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/tce')}}">TCE</a>
                  </li>
