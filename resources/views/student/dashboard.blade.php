            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <p style="font-family: cursive; font-size:30px; font-weight: bold; text-align: center;">60000TK per semester</p>
                </div>
                <div class="dashboard-chart-card-container">
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <p style="font-family: cursive; font-size:30px; font-weight: bold; text-align: center;">120000TK</p>
                </div>
                <div class="dashboard-chart-card-container">
